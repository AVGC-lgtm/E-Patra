...
router.post('/send-inward-letter', dynamicEmailController.sendInwardLetterEmail);
router.get('/contacts', dynamicEmailController.getEmailContacts);
router.get('/debug-file/:letterId', dynamicEmailController.debugFileStructure);
router.get('/test-file-associations/:letterId', dynamicEmailController.testFileAssociations);
router.post('/test-letter-attachments/:letterId', dynamicEmailController.testLetterAttachments);
