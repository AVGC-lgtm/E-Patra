...
const InwardStaffLetters = () => {
  ...
  const handleFileDownload = async (letter, fileIndex = 0) => {
    try {
      ...
      toast.error(language === 'mr' ? 'फाईल डाउनलोड करतांना त्रुटी!' : 'Error downloading file!');
    }
  };
  ...
  const handleGenerateCoveringLetter = async (letter) => {
    try {
      ...
      toast.error(language === 'mr' 
        ? `कव्हरिंग लेटर तयार करतांना त्रुटी: ${errorMessage}` 
  ...
  const handleUploadCoveringLetter = async (letter, file) => {
    try {
      ...
      if (errorMessage.includes('already exists')) {
        ...
        toast.error(language === 'mr' 
          ? `कव्हरिंग लेटर अपलोड करतांना त्रुटी: ${errorMessage}` 
