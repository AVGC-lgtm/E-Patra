  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      if (response.data && Array.isArray(response.data)) {
        console.log('Letters received:', response.data); // Debug log
...
{sendModalOpen && selectedLetterForSend && (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    ...
                    <div>
                      ...
                      <div className="max-h-48 overflow-y-auto border border-green-200 rounded-md p-3 bg-white">
                        <div className="grid grid-cols-1 gap-2">
                          {/* Ahmednagar Police Stations */}
                          {sendToData.selectedDistrict === 'ahmednagar' && [
                          ...
                          {/* Dhule Police Stations */}
                          {sendToData.selectedDistrict === 'dhule' && [
                          ...
                          {/* Placeholder for other districts */}
    ...
    {/* FIXED: Modal for viewing letter details */}
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
        <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full p-8 relative max-h-[90vh] overflow-y-auto border border-blue-100">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              <div className="text-base font-bold text-blue-900 mb-1">
                {t.letterCategory || (language === 'mr' ? 'पत्र वर्गीकरण' : 'Letter Category')}
              </div>
              <div className="text-lg text-gray-800 font-medium whitespace-pre-line">
                {t[selectedLetter.letterCategory] || selectedLetter.letterCategory || 'N/A'}
              </div>
            </div>
            <div className="border-b border-blue-100" />
            ...
            {/* FIXED: Attachments section to handle both structures */}
