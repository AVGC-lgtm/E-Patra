...
const NewLetter = () => {
  ...
  // Table name function removed - no table forwarding needed
  ...
  // Forward-to options removed - no table forwarding needed
    ...
    <div className="space-y-6 relative">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg border border-blue-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* Forward To field removed - no table forwarding needed */}
