const translations = {
  en: {
    ...
    other_application_general: "Other Application",
    other_application_local: "Local Application",
    other_application_anonymous: "Anonymous Application",
    other_application_district_soldier: "District Soldier Application",
    other_application_moneylender_reference: "Moneylender Reference",
    other_application_lokshahi_reference: "Lokshahi Reference",
    other_application_confidential: "Confidential Application",
    
    // B Class Applications
    other_application_b_class_sp_ahmednagar: "B Class - SP Ahmednagar",
    other_application_b_class_upper_sp_ahmednagar: "B Class - Upper SP Ahmednagar",
    
    // C Class Applications
    other_application_c_class_commissioner: "C Class - Commissioner",
    other_application_c_class_district_collector: "C Class - District Collector",
    other_application_c_class_sdpo_shrirampur: "C Class - SDPO Shrirampur",
    other_application_c_class_sdpo_karjat: "C Class - SDPO Karjat",
    other_application_c_class_sdpo_shirdi: "C Class - SDPO Shirdi",
    other_application_c_class_sdpo_shevgaon: "C Class - SDPO Shevgaon",
    other_application_c_class_sdpo_nagar_city: "C Class - SDPO Nagar City",
    other_application_c_class_sdpo_nagar_taluka: "C Class - SDPO Nagar Taluka",
    other_application_c_class_sdpo_sangamner: "C Class - SDPO Sangamner",
    other_application_c_class_all_police_stations: "C Class - All Police Stations",
    other_application_c_class_all_branches: "C Class - All Branches",
    other_application_c_class_sainik_board: "C Class - Sainik Board",
    other_application_c_class_senior_army_officer: "C Class - Senior Army Officer",
    other_application_c_class_lokshahi_din: "C Class - Lokshahi Din",

    // --- Other Mail specific entries ---
    other_mail: "Other Mail",
    other_mail_general: "Other Mail",
    other_mail_confidential: "Confidential",
    other_mail_sanction_offence: "Sanctioned Offence",
    other_mail_deficiency: "Deficiency",
    other_mail_hospital_record: "Hospital Record",
    other_mail_accumulated_leave: "Accumulated Leave Case",
    other_mail_parole_leave: "Parole Leave Case",
    other_mail_weekly_diary: "Weekly Diary",
    other_mail_daily_check: "Daily Check",
    other_mail_fingerprint: "Fingerprint",
    other_mail_medical_bill: "Medical Bill",
    other_mail_tenant_verification: "Tenant Verification",
    other_mail_leave_sanction: "Leave Sanction Matter",
    other_mail_warrant: "Warrant",
    other_mail_explanation_absence: "Explanation/Absence",
    other_mail_death_summary_approval: "Death Summary Approval",
    other_mail_viscera: "Viscera",
    other_mail_departmental_inquiry: "Departmental Inquiry Order",
    other_mail_final_order: "Final Order",
    other_mail_district_police_press_release: "District Police Press Release",
    other_mail_license: "License",
    other_mail_office_inspection: "Office Inspection",
    other_mail_vip_visit: "VIP Visit",
    other_mail_settlement: "Settlement",
    other_mail_reward_punishment: "Reward/Punishment",
    other_mail_charge_officer_order: "Officer in Charge Order",
    other_mail_do: "D.O.",
    other_mail_cyber: "Cyber",
    other_mail_cdr: "CDR",
    other_mail_caf: "CAF",
    other_mail_sdr: "SDR",
    other_mail_imei: "IMEI",
    other_mail_dump_data: "Dump Data",
    other_mail_it_act: "IT Act",
    other_mail_facebook: "Facebook",
    other_mail_online_fraud: "Online Fraud",
    other_mail_self_immolation: "Self-Immolation",
    other_mail_human_rights: "Human Rights Protection",
    other_mail_pcr: "PCR",
    other_mail_steno: "Steno",
    other_mail_typist: "Typist",
    other_mail_cdr_sdr_caf: "CDR/SDR/CAF/IMEI/IPDR/DUMP",
    other_mail_senior_sp: "Senior Mail - SP",
    other_mail_senior_sdpo: "Senior Mail - SDPO",
    other_mail_a_class_pm: "A Class - Hon. Prime Minister",
    other_mail_a_class_cm: "A Class - Hon. Chief Minister",
    other_mail_a_class_deputy_cm: "A Class - Hon. Deputy Chief Minister",
    other_mail_a_class_home_minister: "A Class - Hon. Home Minister",
    other_mail_a_class_mos_home: "A Class - Hon. Minister of State (Home)",
    other_mail_a_class_guardian_minister: "A Class - Hon. Guardian Minister",
    other_mail_a_class_union_minister: "A Class - Union Minister",
    other_mail_a_class_mp: "A Class - MP",
    other_mail_a_class_mla: "A Class - MLA",
    other_mail_a_class_other: "A Class - Other",
    other_mail_treasury: "Treasury",
    other_mail_commandant: "Commandant",
    other_mail_principal_ptc: "Principal - Police Training Center",
    other_mail_c_class_commissioner: "C Class - Police Commissioner",
    other_mail_application_report: "Application Branch Inquiry Report",
    other_mail_appeal: "Appeal",
    other_mail_in_service_training: "In-Service Training",
    other_mail_building_branch: "Building Branch",
    other_mail_pension: "Regarding Pension",
    other_mail_vehicle_license: "Government Vehicle License",
    other_mail_payments: "Payments",
    other_mail_lapses_case: "Lapses Case",
    other_mail_pay_fixation: "Pay Fixation",
    other_mail_transfer: "Transfer",
  ...
  mr: {
    dashboard: 'डॅशबोर्ड',
    newLetter: 'इनवर्ड अर्ज',
    allLetters: 'सर्व अर्ज',
    trackApplication: 'अर्ज ट्रॅक करा',
    logout: 'बाहेर पडा',
    user: 'वापरकर्ता',
    letterSystem: 'अर्ज प्रणाली',
    close: 'बंद करा',
    menu: 'मेनू',
    receivedLetters: 'प्राप्त अर्ज',
    toggleSidebar: 'साइडबार टॉगल करा',
    profile: 'प्रोफाइल',
    settings: 'सेटिंग्ज',
    notifications: 'सूचना',
    uploadLetter: 'अर्जअपलोड करा',
    dragAndDrop: 'फाईल्स येथे ड्रॅग आणि ड्रॉप करा किंवा ब्राउझ करण्यासाठी क्लिक करा',
    selectFiles: 'फाईल्स निवडा',
    receivedByOffice: 'अर्ज पाठविणारे कार्यालय',
    recipientName: 'अर्ज पाठविण्याऱ्याचे नाव व पदनाम',
    designation: 'पदनाम',
    letterClassification: 'अर्ज वर्गीकरण',
    ...
    remove: 'काढून टाका',
    letterSubmitted: 'अर्ज यशस्वीरित्या सबमिट केले!',
    submitError: 'अर्ज सबमिट करण्यात अयशस्वी. कृपया पुन्हा प्रयत्न करा.',
...
// --- Other Application (इतर अर्ज) specific entries ---
// Main Categories
other_application_general: 'Other Application',
other_application_local: 'Local Application',
other_application_anonymous: 'Anonymous Application',
...
other_application_lokshahi_reference: 'Lokshahi Reference',
other_application_confidential: 'Confidential Application',
  other_application_lokshahi_reference: 'लोकशाही संदर्भातील अर्ज',
  other_application_confidential: 'गोपनीय अर्ज',
  
  // B Class Applications
  other_application_b_class_sp_ahmednagar: 'ब वर्ग- मा.पो.अ.सो. अहमदनगर(प्रत्यक्ष भेट)',
  other_application_b_class_upper_sp_ahmednagar: 'ब वर्ग- मा.अप्पर पो.अ. अहमदनगर(प्रत्यक्ष भेट)',
  
  // C Class Applications
  other_application_c_class_commissioner: 'क वर्ग-विभागीय आयुक्त',
  other_application_c_class_district_collector: 'क वर्ग-जिल्हाधिकारी',
  other_application_c_class_sdpo_shrirampur: 'क वर्ग-एस. डी. पी. ओ. श्रीरामपूर',
  other_application_c_class_sdpo_karjat: 'क वर्ग-एस. डी. पी. ओ. कर्जत',
  other_application_c_class_sdpo_shirdi: 'क वर्ग-एस. डी. पी. ओ. शिर्डी',
  other_application_c_class_sdpo_shevgaon: 'क वर्ग-एस. डी. पी. ओ. शेवगाव',
  other_application_c_class_all_police_stations: 'क वर्ग-सर्व पोलीस स्टेशन',
  other_application_c_class_all_branches: 'क वर्ग-सर्व शाखा',
  other_application_c_class_sainik_board: 'क वर्ग-सैनिक बोर्ड',
  other_application_c_class_senior_army_officer: 'क वर्ग-वरिष्ठ आर्मी अधिकारी',
  other_application_c_class_lokshahi_din: 'क वर्ग-लोकशाही दिन',
  other_application_c_class_sdpo_nagar_city: 'क वर्ग-एस. डी. पी. ओ नगर शहर',
  other_application_c_class_sdpo_nagar_taluka: 'क वर्ग-एस. डी. पी. ओ नगर तालुका',
  other_application_c_class_sdpo_sangamner: 'क वर्ग-एस. डी. पी. ओ संगमनेर',
...
// --- Other Mail (इतर टपाल) specific entries ---
  ...
  other_mail_leave_record: 'संचित रजा प्रकरण',
  other_mail_payroll_leave: 'पॅरोल रजा प्रकरण',
  ...
  other_mail_leave_approval: 'रजा मंजुरी बाबत',
  other_mail_warrant: 'वॉरंट',
  other_mail_disclosure: 'खुलासा/गैरहजर',
  other_mail_postmortem_approval: 'मयत समरी मंजुरी बाबत',
  other_mail_viscera: 'व्हीसेरा',
  other_mail_departmental_inquiry_order: 'विभागीय चौकशी आदेश',
  other_mail_final_order: 'अंतिम आदेश',
  other_mail_district_police_bulletin: 'जिल्हा पोलीस प्रसिद्धी पत्रक',
  other_mail_license: 'अनुज्ञाप्ती',
  other_mail_office_inspection: 'दफ्तर तपासणी',
  other_mail_vip_visit: 'व्ही आय पी दौरा',
  other_mail_settlement: 'बंदोबस्त',
  other_mail_reward_punishment: 'बक्षीस / शिक्षा',
  other_mail_charge_officer_order: 'प्रभारी अधिकारी आदेश',
  other_mail_do: 'डि. ओ.',
  
  // Cyber and Technical
  other_mail_cyber: 'सायबर',
  other_mail_cdr: 'CDR',
  other_mail_caf: 'CAF',
  other_mail_sdr: 'SDR',
  other_mail_imei: 'IMEI',
  ...
  other_mail_facebook: 'FACEBOOK',
  other_mail_online_fraud: 'ONLINE FRAUD',
  other_mail_self_immolation: 'आत्मदहन',
  other_mail_human_rights: 'नागरी हक्क संरक्षण',
  other_mail_pcr: 'PCR',
  other_mail_steno: 'STENO',
  other_mail_typist: 'लघुलेखक',
  other_mail_cdr_sdr_caf: 'CDR/SDR/CAF/IMEI/IPDR/DUMP',
  
  // Senior Mail
  other_mail_senior_sp: 'वरिष्ठ टपाल – एसपी',
  other_mail_senior_sdpo: 'वरिष्ठ टपाल – एसडीपीओ',
  
  // A-Class
  other_mail_a_class_pm: 'अ वर्ग- मा. पंतप्रधान',
  other_mail_a_class_cm: 'अ वर्ग- मा. मुख्यमंत्री',
  other_mail_a_class_deputy_cm: 'अ वर्ग- मा. उपमुख्यमंत्री',
  other_mail_a_class_home_minister: 'अ वर्ग- मा. गृहमंत्री',
  other_mail_a_class_mos_home: 'अ वर्ग- मा. गृहराज्यमंत्री',
  other_mail_a_class_guardian_minister: 'अ वर्ग- मा. पालक मंत्री',
  other_mail_a_class_union_minister: 'अ वर्ग- केंद्रीय मंत्री',
  other_mail_a_class_mp: 'अ वर्ग- खासदार',
  other_mail_a_class_mla: 'अ वर्ग- आमदार',
  other_mail_a_class_other: 'अ वर्ग- इतर',
  
  // Other Categories
  other_mail_treasury: 'कोषागार',
  other_mail_commandant: 'समादेशक',
  other_mail_principal_ptc: 'प्राचार्य -पोलीस प्रशिक्षण केंद्र',
  other_mail_c_class_commissioner: 'क वर्ग -पोलीस आयुक्त',
  other_mail_application_report: 'अर्ज शाखा चौकशी अहवाल',
  other_mail_appeal: 'अपील',
  other_mail_in_service_training: 'सेवांतर्गत प्रशिक्षण',
  other_mail_building_branch: 'इमारत शाखा',
  other_mail_pension: 'पेन्शन संदर्भात',
  other_mail_vehicle_license: 'शासकीय वाहन परवाना',
  other_mail_payments: 'देयके',
  other_mail_departmental_inquiry: 'विभागीय चौकशी',
  other_mail_lapses_case: 'कसुरी प्रकरण',
  other_mail_pay_fixation: 'वेतननिश्चिती',
  other_mail_transfer: 'बदली',
  other_mail_district_police_bulletin: 'जिल्हा पोलीस प्रसिद्धी पत्रक',
  other_mail_license: 'अनुज्ञाप्ती',
  other_mail_office_inspection: 'दफ्तर तपासणी',
  other_mail_vip_visit: 'व्ही आय पी दौरा',
...
other_mail_medical_bill: 'वैद्यकीय बील',
other_mail_tenant_verification: 'टेनेंट व्हेरीफिकेशन',
other_mail_leave_approval: 'रजा मंजुरी बाबत',
other_mail_warrant: 'वॉरंट',
other_mail_disclosure: 'खुलासा/गैरहजर',
other_mail_postmortem_approval: 'मयत समरी मंजुरी बाबत',
other_mail_viscera: 'व्हीसेरा',
other_mail_departmental_inquiry: 'विभागीय चौकशी आदेश',
other_mail_final_order: 'अंतिम आदेश',
other_mail_district_police_bulletin: 'जिल्हा पोलीस प्रसिद्धी पत्रक',
other_mail_license: 'अनुज्ञाप्ती',
other_mail_office_inspection: 'दफ्तर तपासणी',
